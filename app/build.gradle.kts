...
android {
    ...
    defaultConfig {
        ...
        // 26 = Android 8.0+ (каналы уведомлений, широкая поддержка старых аппаратов).
        // GymProgress: minSdk 29 — на Android 9 и ниже APK не ставится вовсе.
        minSdk = 26
        targetSdk = 36
        ...
        logger.lifecycle("[VoiceMind] versionName=$versionName, versionCode=$versionCode, buildDate=$buildDate")
    }
