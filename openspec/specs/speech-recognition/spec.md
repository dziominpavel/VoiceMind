...
On-device распознавание речи (ru-RU) для голосового ввода напоминаний без хранения аудио.

## Requirements

### Requirement: On-device STT
Приложение MUST использовать SpeechRecognizer с on-device движком, locale ru-RU.
...
Если on-device STT недоступен или вернул ошибку, приложение MUST fallback на RecognizerIntent.
...
Если пользователь молчит более 10 секунд, STT MUST автоматически остановиться.
...
Приложение MUST NOT записывать аудиозаписи на диск в MVP.
...
Приложение MUST обрабатывать ошибки STT без крашей.
